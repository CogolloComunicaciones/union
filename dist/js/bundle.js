  ...
  if ($("#chartContainer").length > 0) {
    var chart = new CanvasJS.Chart("chartContainer", {
      ...
      data: [{
        ...
        dataPoints: [{
          y: 5.5,
          label: "Bonos Extranjeros"
        }, {
          y: 8,
          label: "Criptoactivos"
        }, {
          y: 9.8,
          label: "Factoring Latam y USA"
        }, {
          y: 10.1,
          label: "Mercado Inmobiliario"
        }, {
          y: 10.25,
          label: "Participaciones de Factoring Institucional"
        }, {
          y: 26.75,
          label: "Divisas (Arbitraje, forex)"
        }, {
          y: 28.6,
